...
@Gtk.Template(resource_path='/text/edit/simple/window.ui')
class SimpletexteditorWindow(Gtk.ApplicationWindow):
    __gtype_name__ = 'SimpletexteditorWindow'
    ...
    def save_file_complete(self, file, result):
        ...
        if not res:
            ...
            self.toast_overlay.add_toast(Adw.Toast(title=f"\"{display_name}\" Saved"))
...
class AboutDialog(Gtk.AboutDialog):
    ...
    def __init__(self, parent):
        ...
        self.props.program_name = 'simpletexteditor'
        self.props.version = "0.1.0"
        self.props.authors = ['Eliot Alderson']
        self.props.copyright = '2022 Eliot Alderson'
        self.props.logo_icon_name = 'text.edit.simple'
